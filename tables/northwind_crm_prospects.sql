...
CREATE TABLE `crm_prospects` (
  ...
  `prospects_name` varchar(45) NOT NULL,
  `prospects_phone` int(11) NOT NULL,
  `lead_id` int(11) NOT NULL,
  PRIMARY KEY (`prospects_id`),
  KEY `lead_id_idx` (`lead_id`),
  CONSTRAINT `lead_id` FOREIGN KEY (`lead_id`) REFERENCES `crm_leads` (`id_leads`) ON DELETE NO ACTION ON UPDATE NO ACTION
